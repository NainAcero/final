<?php
    ...
    define('BASEPATH', IS_LOCAL ? '/covid/' : '__EL BASEPATH EN PRODUCCIÓN__');

    define('AUTH_SALT', 'HACKATHON');                                        /* Sal del Sistema */

    define('PORT','80');

    define('URL', IS_LOCAL ? 'http://127.0.0.1:'.PORT.'/covid/' : 'http://143.110.146.220/');
